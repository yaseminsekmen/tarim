 ...
 <section class="content">
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box-body">
        <form method="post"  enctype="multipart/form-data" autocomplete="off" action="<?=base_url()?>admin/hizmetlerimiz/ekle_kaydet" role="form">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" name="hizmet_adi"  class="form-control" id="email1" placeholder="">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
           <textarea name="hizmet_aciklama" class="ckeditor" id=""></textarea>
         </div>
       </div>
